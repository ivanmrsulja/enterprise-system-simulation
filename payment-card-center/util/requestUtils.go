...
var BaseIssuerBank1PathRoundRobin, _ = roundrobin.New(
	&url.URL{Host: "https://www.sep-banka.com:8084/api/issuer-bank"},
)

var BaseIssuerBank2PathRoundRobin, _ = roundrobin.New(
	&url.URL{Host: "https://www.sep-banka.com:8085/api/issuer-bank"}, // Hipoteticka banka, mozda da roknemo issuer-bank u 2 kontejnera pa namapiramo na 2 port-a ? :)
)

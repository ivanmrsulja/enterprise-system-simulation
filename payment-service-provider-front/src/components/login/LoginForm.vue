            ...
            <v-row align="center" justify="center">
              <v-col cols="8" sm="8" md="8" lg="10" xl="10">
                <v-btn
                  ...
                  type="submit"
                  :disabled="
                    payload.merchantId === '' || payload.merchantPassword === ''
                  "
...
export default {
  ...
  methods: {
    login() {
      ...
      authService
        ...
        .then((response) => {
          ...
          this.text =
            "We have sent you a 2FA code. Check your email and enter the code in the given box.";
          this.snackbar = true;
        })
        .catch((error) => {
    ...
    loginSecondStep() {
      ...
      authService
        .loginSecondStep({
          merchantId: this.payload.merchantId,
          pinCode: this.authCode,
        })
        .then((response) => {

...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/payment-methods/business-account").permitAll()
                .antMatchers(HttpMethod.GET, "/api/payment-methods/business-account/{merchantId}/{paymentMethod}").permitAll()

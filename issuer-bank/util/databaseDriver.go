...
var (
	accounts = []model.BankAccount{
		...
		{Pan: Bytes2StrRaw(Hash("3213213213")), SecurityCode: Bytes2StrRaw(Hash("321")), CardHolderName: Bytes2StrRaw(Hash("Milos Popovic")), ExpiryDate: Bytes2StrRaw(Hash("05/23")), Balance: 20000},
		{Pan: Bytes2StrRaw(Hash("1111111111")), SecurityCode: Bytes2StrRaw(Hash("456")), CardHolderName: Bytes2StrRaw(Hash("Veljko Tosic")), ExpiryDate: Bytes2StrRaw(Hash("08/25")), Balance: 30000},
	}
)

...
var (
	accounts = []model.BankAccount{
		...
		{Pan: Bytes2StrRaw(Hash("1231211111")), SecurityCode: Bytes2StrRaw(Hash("456")), CardHolderName: Bytes2StrRaw(Hash("Veljko Tosic")), ExpiryDate: Bytes2StrRaw(Hash("08/25")), Balance: 30000},
	}
)
